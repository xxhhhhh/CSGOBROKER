function copyToClipboard(element) {
  ...
  function translateURLs(parentElement, language) {
    var translations = {
      ...
      "es": {
        "CSMoney - Premier CS2/Dota 2 trading site since 2016. Vast selection, HD images, anti-scam, fast support. Reliable, user-friendly gaming platform.": "CSMoney - Sitio de comercio líder de CS:GO/Dota 2 desde 2016. Amplia selección, imágenes en alta definición, protección contra estafas, soporte rápido. Plataforma de juego confiable y fácil de usar.",
      ...
      "ru": {
        ...
        "Bounty Stars - gambling platform for CS2 and Rust with original games, fair gameplay, bonuses, and impressive animations. Opened in 2023.": "Bounty Stars - игровая платформа для CS2 и Rust с оригинальными играми, честным геймплеем, бонусами и впечатляющей анимацией.",
        ...
        "CSGOFast is a CS2 skin gambling site that offers a wide range of exclusive game modes. One of the earliest CSGO gambling sites.": "CSGOFast - это сайт для азартных игр на скины CS2, который предлагает широкий выбор эксклюзивных игровых режимов.",
        ...
        "Key-Drop is a reputable online platform focused on Case Opening and Case Battles, as well as custom CS2 skin cases, featuring regular giveaways.": "Key-Drop - надежная платформа, специализирующаяся на открытии и битве кейсов, с регулярными розыгрышами и акциями.",
