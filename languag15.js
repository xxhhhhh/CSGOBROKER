  ...
  if (!window.location.pathname.includes('/reviews/') && !window.location.pathname.includes('/ru/') && !window.location.pathname.includes('/mirrors/')) {
    ...
    var translations = {
      "hi": {
        ...
        "Lis-Skins is a popular marketplace for Steam items, especially CS2, Rust and Dota 2 skins and items. The platform was founded in 2020.": "Lis-Skins एक लोकप्रिय मार्केटप्लेस है जहाँ प्रतिस्पर्धी कीमतों पर CS2, Dota 2 और Rust के आइटमों को जल्दी बेचने की सुविधा है।",
        ...
        "Moon.Market - a platform for the quick sale of items from games CS2, Dota 2, Rust, and TF2 at fair prices with fast payouts.": "Moon.Market - CS2, Dota 2, Rust, और TF2 खेलों के आइटम्स को तेजी से बेचने के लिए एक प्लेटफ़ॉर्म, उचित कीमतों पर और तेज़ भुगतान के साथ।",
        ...
        "+180% Deposit Bonus": "+180% जमा बोनस",
        "+300% Deposit Bonus": "+300% जमा बोनस",
        ...
        "Free 500 Coins": "500 सिक्के मुफ्त",
      ...
      "tr": {
        ...
        "Lis-Skins is a popular marketplace for Steam items, especially CS2, Rust and Dota 2 skins and items. The platform was founded in 2020.":"Lis-Skins, rekabetçi fiyatlarla ve CS2, Dota 2 ve Rust eşyalarını hızlı bir şekilde satma imkanıyla popüler bir pazar yeridir.",
        "SkinCashier is an online platform that allows players to Instant Sell their CS2, Rust, Dota 2, and TF2 skins for real money. Operating since 2020.": "SkinCashier, CS2, Rust, Dota 2 ve TF2 kaplamalarını anında satmanızı sağlayan bir çevrimiçi platformdur. 2020'den beri faaliyette.",
        ...
        "Moon.Market - a platform for the quick sale of items from games CS2, Dota 2, Rust, and TF2 at fair prices with fast payouts.": "Moon.Market - CS2, Dota 2, Rust ve TF2 oyunlarındaki öğeleri hızlı bir şekilde satmak için adil fiyatlarla ve hızlı ödemelerle bir platform.",
        ...
        "+180% Deposit Bonus" : "+180% Depozito Bonusu",
        "+300% Deposit Bonus" : "+300% Depozito Bonusu",
      ...
      "es": {
        ...
        "Lis-Skins is a popular marketplace for Steam items, especially CS2, Rust, and Dota 2 skins and items. The platform was founded in 2020.": "Lis-Skins es un mercado popular con precios competitivos y la capacidad de vender rápidamente artículos de CS2, Dota 2 y Rust.",
        "SkinCashier is an online platform that allows players to Instant Sell their CS2, Rust, Dota 2, and TF2 skins for real money. Operating since 2020.": "SkinCashier es una plataforma en línea que permite vender instantáneamente skins de CS2, Rust, Dota 2 y TF2 por dinero real. Desde 2020.",
        ...
        "Moon.Market - a platform for the quick sale of items from games CS2, Dota 2, Rust, and TF2 at fair prices with fast payouts.": "Moon.Market - una plataforma para la venta rápida de artículos de los juegos CS2, Dota 2, Rust y TF2 a precios justos con pagos rápidos.",
        ...
        "+180% Deposit Bonus": "+180% Bono de depósito",
        "+300% Deposit Bonus": "+300% Bono de depósito",
      ...
      "pt": {
        ...
        "Lis-Skins is a popular marketplace for Steam items, especially CS2, Rust and Dota 2 skins and items. The platform was founded in 2020.":"Lis-Skins é um mercado popular com preços competitivos e a capacidade de vender rapidamente itens de CS2, Dota 2 e Rust.",
        ...
        "Moon.Market - a platform for the quick sale of items from games CS2, Dota 2, Rust, and TF2 at fair prices with fast payouts.": "Moon.Market - uma plataforma para a venda rápida de itens dos jogos CS2, Dota 2, Rust e TF2 a preços justos com pagamentos rápidos.",
        ...
        "+180% Deposit Bonus": "+180% Bónus de Depósito",
        "+300% Deposit Bonus": "+300% Bónus de Depósito",
