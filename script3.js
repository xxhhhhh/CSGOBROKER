...
if ((window.location.pathname.startsWith('/pt/') || window.location.pathname === '/pt' || window.location.pathname === '/pt.html') && !window.location.pathname.includes('/reviews/')) {
  ...
  function translateURLs(parentElement) {
    var translations = {
      ...
      "Tradeit is an online marketplace that offers players the opportunity to trade, buy, and sell skins for a variety of games, including CS:GO. Working since 2017.":"Tradeit é um mercado online de skins de jogos, incluindo CS:GO, onde os jogadores podem trocar, comprar e vender skins. Trabalhando desde 2017.",
      ...
      "Swap.gg is a website that allows users to buy, sell, and trade CS:GO, Rust , TF2 and other virtual items from various games. Working since 2017.":"Swap.gg é um site que permite aos usuários comprar, vender e trocar itens virtuais de CS:GO, Rust, TF2 e outros jogos. Trabalhando desde 2017.",
      "BitSkins is an online marketplace for in-game skins, particularly for Counter-Strike: Global Offensive, Dota 2, and Team Fortress 2. Launched in 2015.":"BitSkins é um mercado online para skins de jogos, especialmente para Counter-Strike: Global Offensive, Dota 2 e Team Fortress 2. Lançado em 2015.",
      ...
      "BitSkins P2P is an online platform for buying and selling virtual items, with a focus on CS:GO skins. The parent company, BitSkins.":"BitSkins P2P é uma plataforma online para compra e venda de itens virtuais, com foco em skins de CS:GO. A empresa-mãe, BitSkins.",
      "Trusted CS:GO skin platform with rentals, endorsed by YouTubers. Secure, limited to CS:GO skins, fees apply, and user reviews indicate room for improve.":"Plataforma confiável de skins CS:GO com aluguel, endossada por YouTubers. Segura, limitada a skins de CS:GO, taxas aplicáveis, avaliações indicam melhorias.",
      "GamerPay is a trusted platform for buying and selling CS:GO skins, with a free selling option, secure transactions, and high-quality skin inspection tool.":"GamerPay é uma plataforma confiável para compra e venda de skins de CS:GO. Venda gratuita, transações seguras, inspeção de skins de alta qualidade.",
      "CSGO Market is an online P2P marketplace that provides a safe and secure platform for buying and selling CS:GO skins. Established in 2015.":"CSGO Market é um mercado P2P online que oferece uma plataforma segura para comprar e vender skins de CS:GO. Estabelecido em 2015.",
      "Lis-Skins is a popular marketplace for Steam items, especially CS:GO, Rust and Dota 2 skins and items. The platform was founded in 2020.":"Lis-Skins é um mercado popular para itens do Steam, especialmente skins e itens de CS:GO, Rust e Dota 2. A plataforma foi fundada em 2020.",
      "WhiteMarket is a P2P platform for CS:GO skin trading. It offers secure trades, various deposit options, and community engagement.":"WhiteMarket é uma plataforma P2P segura para negociação de skins de CS:GO com opções de depósito e envolvimento da comunidade.",
      "CS.Deals is a platform that allows users to buy, sell, and trade skins from popular games such as CS:GO, Dota 2, Rust, and Team Fortress 2. Working since 2016.":"CS.Deals é uma plataforma para comprar, vender e trocar skins de jogos populares como CS:GO, Dota 2, Rust e Team Fortress 2 desde 2016.",
      "SkinBid is an online marketplace for CS:GO skins and in-game items, offering buying, selling, and auctioning features with a user-friendly interface.":"SkinBid é um mercado online para skins de CS:GO e itens de jogos, oferecendo recursos de compra, venda e leilão com uma interface amigável.",
      "LOOT.Farm is an online platform that offers users the ability to Trade virtual items from popular games like CS:GO, Dota 2, Team Fortress 2, and Rust.":"LOOT.Farm é uma plataforma online para negociação de itens virtuais de jogos populares como CS:GO, Dota 2, TF2 e Rust.",
      "SkinBaron is an online platform based in Germany that enables users to buy and sell their CS:GO skins. The platform has gained a good reputation.":"SkinBaron é uma plataforma online alemã para compra e venda de skins de CS:GO com boa reputação.",
      "Gamdom is one of the best CS:GO Match Betting Sites. You can play Roulette, Wheel, Crash, Slots and many more!":"A Gamdom é um dos melhores sites de apostas em partidas de CS:GO. Você pode jogar Roleta, Roda da Sorte, Crash, Caça-níqueis e muitos outros!",
      "SkinCashier is an online platform that allows players to Instant Sell their CS:GO, Rust, Dota 2, and TF2 skins for real money. Operating since 2020.": "SkinCashier é uma plataforma online de venda instantânea de skins de CS:GO, Rust, Dota 2 e TF2 por dinheiro real desde 2020.",
      "Avan.Market is an online platform that offers users the opportunity to sell gaming skins from popular games like CS:GO, Dota 2, RUST, and TF2.": "Avan.Market é uma plataforma online que oferece aos usuários a oportunidade de vender skins de jogos populares como CS:GO, Dota 2, RUST e TF2.",
      ...
      "CYBERSHOKE is a website that provides servers for playing CS:GO. It offers various servers for players to choose.":"A CYBERSHOKE é um site que disponibiliza servidores para jogar CS:GO. Ele oferece vários servidores para os jogadores escolherem.",
  ...
  function translateURLs(parentElement) {
    ...
    for (var i = 0; i < links.length; i++) {
      ...
      var translations = {
        ...
        "Earn by Play CS:GO": "Gana jugando CS:GO",
...
if ((window.location.pathname.startsWith("/es/") || window.location.pathname === "/es" || window.location.pathname === "/es.html") && !window.location.pathname.includes("/reviews/")) {
  ...
  function translateURLs(parentElement) {
    var translations = {
      "CSGO500 probably the best CS:GO Gambling Site. Regular rains, giveaways and promocodes. You can play many games and slots.": "CSGO500, el mejor sitio de apuestas de CS:GO. Lluvias, regalos y códigos promocionales. Juegos y tragamonedas disponibles.",
      "CSGO500 probably the best CS:GO and Rust Gambling Site. Regular rains, giveaways and promocodes. You can play many games and slots.": "CSGO500, el mejor sitio de apuestas de CS:GO. Lluvias, regalos y códigos promocionales. Juegos y tragamonedas disponibles.",
      ...
      "Rustix - gambling platform for CS:GO and Rust with original games, fair gameplay, bonuses, and impressive animations. Opened in 2023.": "Rustix: plataforma de apuestas para CS:GO y Rust con juegos originales, juego justo, bonificaciones e impresionantes animaciones.",
      "CSGO-Skins is a reputable online platform where users can open custom CS:GO cases and participate in daily Giveaways.": "CSGO-Skins es una plataforma en línea confiable donde los usuarios pueden abrir estuches personalizados de CS:GO y participar en sorteos diarios.",
      "FlameCases is an online platform that permits users to open cases for CS:GO and Dota 2. Since its launch in 2017, the website provides various features.": "FlameCases es una plataforma en línea que permite abrir estuches para CS:GO y Dota 2. Desde 2017, el sitio web ofrece varias funciones.",
      "KNIFEX is a CS:GO gambling site that offers a range of game modes, including case opening, case battles, coinflip, crash, clash and many more!": "KNIFEX es un sitio de apuestas de CS:GO con múltiples modos de juego, incluyendo apertura y batallas de estuches, coinflip, crash, clash y más.",
      "DatDrop is a website that specializes in opening cases that contain skins from CS:GO. Its most prominent feature is the case-opening battles.": "DatDrop es un sitio web especializado en abrir estuches que contienen skins de CS:GO. Su característica más destacada son las batallas de apertura de estuches.",
      ...
      "Clash.gg is a new CS:GO Gambling site which includes many games like Roulette, Upgrader, Cases and many more !": "Clash.gg es un nuevo sitio de apuestas de CS:GO que incluye muchos juegos como la ruleta, upgrader, estuches ¡y muchos más!",
      ...
      "Hellcase is an online platform that allows users to purchase virtual cases filled with skins and items for various games such as CS:GO, Dota 2, and Rust.": "Hellcase es una plataforma en línea donde puedes comprar estuches virtuales con skins y objetos para juegos como CS:GO, Dota 2 y Rust.",
      "CSGOBIG - a gambling site for CS:GO skins with game modes like Jackpot, Coinflip, Roulette, Cases, and Case Battles. Opened in 2015.": "CSGOBIG: un sitio de apuestas de skins de CS:GO con modos de juego como Jackpot, Coinflip, Ruleta, Estuches y Batallas de Estuches. Abrió en 2015.",
      ...
      "CSGOLive is a safe and legitimate CS:GO case opening website with custom cases, daily bonuses, and a Provably Fair system.": "CSGOLive es un sitio web seguro de apertura de estuches de CS:GO con estuches personalizados, bonos diarios y un sistema justo.",
      ...
      "Bets4.pro is an online platform that offers users the ability to place bets on esports matches, particularly for CS:GO , Dota 2, Valorant and many more.": "Bets4.pro es una plataforma en línea que ofrece apuestas en partidos de deportes electrónicos, incluyendo CS:GO, Dota 2, Valorant y más.",
      ...
      "SkinSwap is an online platform that allows players to trade and sell skins from popular games such as CS:GO and Rust. Owned and operated by RustySell.":"SkinSwap es una plataforma en línea para intercambiar y vender skins de juegos populares como CS:GO y Rust. Propiedad de RustySell.",
      ...
      "xplay is a platform that allows CS:GO players to earn skins just by playing on their servers. The platform offers various servers and daily challenges.": "xplay es una plataforma que permite a los jugadores de CS:GO ganar skins jugando en sus servidores. Ofrece diversos servidores y desafíos diarios.",
      ...
      "Tradeit is an online marketplace that offers players the opportunity to trade, buy, and sell skins for a variety of games, including CS:GO. Working since 2017.": "Tradeit es un mercado en línea que permite a los jugadores intercambiar, comprar y vender skins de varios juegos, como CS:GO. Funciona desde 2017.",
      ...
      "Swap.gg is a website that allows users to buy, sell, and trade CS:GO, Rust, TF2, and other virtual items from various games. Working since 2017.": "Swap.gg es un sitio web que permite a los usuarios comprar, vender e intercambiar skins de CS:GO, Rust, TF2 y otros objetos virtuales de varios juegos. Funciona desde 2017.",
      "BitSkins is an online marketplace for in-game skins, particularly for Counter-Strike: Global Offensive, Dota 2, and Team Fortress 2. Launched in 2015.": "BitSkins es un mercado en línea para skins de juegos, especialmente para Counter-Strike: Global Offensive, Dota 2 y Team Fortress 2. Lanzado en 2015.",
      ...
      "BitSkins P2P is an online platform for buying and selling virtual items, with a focus on CS:GO skins. The parent company, BitSkins.": "BitSkins P2P es una plataforma en línea para comprar y vender artículos virtuales, con un enfoque en skins de CS:GO. La empresa matriz es BitSkins.",
      "Trusted CS:GO skin platform with rentals, endorsed by YouTubers. Secure, limited to CS:GO skins, fees apply, and user reviews indicate room for improvement.": "Plataforma confiable de skins de CS:GO con alquileres, respaldada por YouTubers. Segura, limitada a skins de CS:GO, se aplican tarifas y las reseñas de los usuarios indican que hay margen de mejora.",
      "GamerPay is a trusted platform for buying and selling CS:GO skins, with a free selling option, secure transactions, and high-quality skin inspection tool.": "GamerPay: plataforma confiable de compra y venta de skins de CS:GO. Venta gratuita, transacciones seguras y alta calidad en la inspección de skins.",
      "CSGO Market is an online P2P marketplace that provides a safe and secure platform for buying and selling CS:GO skins. Established in 2015.": "CSGO Market es un mercado P2P en línea que ofrece una plataforma segura para comprar y vender skins de CS:GO. Establecido en 2015.",
      "Lis-Skins is a popular marketplace for Steam items, especially CS:GO, Rust, and Dota 2 skins and items. The platform was founded in 2020.": "Lis-Skins es un mercado popular para artículos de Steam, especialmente skins e items de CS:GO, Rust y Dota 2. La plataforma fue fundada en 2020.",
      "WhiteMarket is a P2P platform for CS:GO skin trading. It offers secure trades, various deposit options, and community engagement.": "WhiteMarket: plataforma P2P para intercambio seguro de skins de CS:GO con opciones de depósito y participación comunitaria.",
      "CS.Deals is a platform that allows users to buy, sell, and trade skins from popular games such as CS:GO, Dota 2, Rust, and Team Fortress 2. Working since 2016.": "CS.Deals es una plataforma para comprar, vender y intercambiar skins de juegos populares como CS:GO, Dota 2, Rust y Team Fortress 2.",
      "SkinBid is an online marketplace for CS:GO skins and in-game items, offering buying, selling, and auctioning features with a user-friendly interface.": "SkinBid: mercado en línea para skins de CS:GO y objetos de juego con funciones de compra, venta y subasta y una interfaz intuitiva.",
      "LOOT.Farm is an online platform that offers users the ability to trade virtual items from popular games like CS:GO, Dota 2, Team Fortress 2, and Rust.": "LOOT.Farm es una plataforma en línea que ofrece a los usuarios la posibilidad de intercambiar objetos virtuales de juegos populares como CS:GO, Dota 2, Team Fortress 2 y Rust.",
      "SkinBaron is an online platform based in Germany that enables users to buy and sell their CS:GO skins. The platform has gained a good reputation.": "SkinBaron es una plataforma en línea alemana para comprar y vender skins de CS:GO, reconocida por su excelente reputación.",
      "Gamdom is one of the best CS:GO match betting sites. You can play roulette, wheel, crash, slots, and many more!": "Gamdom es uno de los mejores sitios de apuestas en partidas de CS:GO. ¡Puedes jugar a la ruleta, la rueda, el crash, las tragamonedas y mucho más!",
      "SkinCashier is an online platform that allows players to instantly sell their CS:GO, Rust, Dota 2, and TF2 skins for real money. Operating since 2020.": "SkinCashier es una plataforma en línea que permite a los jugadores vender al instante sus skins de CS:GO, Rust, Dota 2 y TF2 por dinero real. Operando desde 2020.",
      "Avan.Market is an online platform that offers users the opportunity to sell gaming skins from popular games like CS:GO, Dota 2, RUST, and TF2.": "Avan.Market es una plataforma en línea que ofrece a los usuarios la oportunidad de vender skins de juegos populares como CS:GO, Dota 2, RUST y TF2.",
      ...
      "CYBERSHOKE is a website that provides servers for playing CS:GO. It offers various servers for players to choose.":"CYBERSHOKE es un sitio web que ofrece servidores para jugar CS:GO. Ofrece varios servidores para que los jugadores elijan.",
      ...
      "Withdraw CS:GO Skins, Crypto or Real Money!": "Retira Skins de CS:GO, criptomonedas o dinero!",
      "Withdraw CS:GO, Dota 2, TF2 or Rust Items!": "Retira items de CS:GO, Dota 2, TF2 o Rust!",
      "Withdraw CS:GO Skins, Crypto or Game Keys!": "Retira skins de CS:GO, criptomonedas o juegos.",
      "Withdraw CS:GO Skins, Crypto or PayPal!": "Retira Skins de CS:GO, criptomonedas o PayPal!",
      "Withdraw Money, CS:GO, TF2 or Rust Skins!": "Retira dinero, Skins de CS:GO, TF2 o Rust!",
      "Withdraw CS:GO Skins, Dota 2 and H1Z1 Items!": "Retira Skins de CS:GO, Dota 2 y items de H1Z1!",
      "Withdraw CS:GO, Rust Skins and Dota 2 Items!": "Retira Skins de CS:GO, Rust y items de Dota 2!",
      ...
      "Withdraw CS:GO Skins, Gift Cards or Crypto!": "Retira Skins CS:GO, tarjetas regalo o criptomonedas!",
      ...
      "Withdraw CS:GO Skins or Items!": "Retira Skins o items de CS:GO!",
      ...
      "Withdraw CS:GO And Rust Skins or Crypto!": "Retira Skins de CS:GO y Rust o criptomonedas!",
      "Withdraw CS:GO Skins or real Money!": "Retira Skins de CS:GO o dinero real!",
      ...
      "Withdraw Money, CS:GO or Rust Skins!": "Retira dinero, Skins de CS:GO o Rust!",
      "Withdraw Money, Crypto or Skins!": "Retira dinero, criptomonedas o Skins!",
      "Withdraw CS:GO Skins or Crypto!": "Retira Skins de CS:GO o criptomonedas!",
      "Withdraw Money, Crypto or PayPal!": "Retira dinero, criptomonedas o PayPal!",
      "WITHDRAW WITH P2P CS:GO SKINS.": "RETIRA CON SKINS P2P DE CS:GO.",
      "Withdraw Real Money or Crypto!": "Retira dinero real o criptomonedas!",
      "Withdraw BTC, ETH, USDT or Tron!": "Retira BTC, ETH, USDT o Tron!",
      "Withdraw CS:GO Skins or PayPal!": "Retira Skins de CS:GO o PayPal!",
      "Withdraw CS:GO Skins and Items!": "Retira Skins e items de CS:GO!",
...
if ((window.location.pathname.startsWith("/tr/") || window.location.pathname === "/tr" || window.location.pathname === "/tr.html") && !window.location.pathname.includes("/reviews/")) {
  ...
  function translateURLs(parentElement) {
    var translations = {
      ...
      "FlameCases is an online platform that permits users to open cases for CS:GO and Dota 2. Since its launch in 2017, the website provides various features.": "FlameCases, CS:GO ve Dota 2 için estuches açma imkanı sağlayan bir çevrimiçi platformdur. 2017'den bu yana hizmet vermektedir.",
      ...
      "Hellcase is an online platform that allows users to purchase virtual cases filled with skins and items for various games such as CS:GO, Dota 2, and Rust.": "Hellcase, CS:GO, Dota 2 ve Rust gibi oyunlar için skin ve eşya dolu sanal estuches satın almanıza olanak sağlayan bir çevrimiçi platformdur.",
      ...
      "SkinSwap is an online platform that allows players to trade and sell skins from popular games such as CS:GO and Rust. Owned and operated by RustySell.":"SkinSwap, CS:GO ve Rust gibi popüler oyunlardan skinleri ticaret yapmanıza ve satmanıza izin veren bir çevrimiçi platformdur.",
      ...
      "xplay is a platform that allows CS:GO players to earn skins just by playing on their servers. The platform offers various servers and daily challenges.": "CS:GO oyuncularının sunucularında oynayarak skin kazanmasını sağlayan bir platformdur. Çeşitli sunucular ve günlük meydan okumalar sunar.",
      ...
      "Tradeit is an online marketplace that offers players the opportunity to trade, buy, and sell skins for a variety of games, including CS:GO. Working since 2017.": "Tradeit, CS:GO ve diğer oyunlar için skin takasını, alımını ve satımını sağlayan çevrimiçi bir pazardır. 2017'den beri hizmet vermektedir.",
      ...
      "BitSkins is an online marketplace for in-game skins, particularly for Counter-Strike: Global Offensive, Dota 2, and Team Fortress 2. Launched in 2015.": "BitSkins, CS:GO, Dota 2 ve Team Fortress 2 gibi oyunlardaki skinleri alıp satabileceğiniz çevrimiçi bir pazardır. 2015 yılında kurulmuştur.",
      ...
      "CS.Deals is a platform that allows users to buy, sell, and trade skins from popular games such as CS:GO, Dota 2, Rust, and Team Fortress 2. Working since 2016.": "CS.Deals, CS:GO, Dota 2, Rust ve Team Fortress 2 gibi oyunlardan skin alım ve satımını sağlayan bir platformdur. 2016'dan beri aktiftir.",
      ...
      "Withdraw CS:GO Skins, Gift Cards or Crypto!" : "CS:GO Skins, hediye kartları ve gerçek para çekin!",
...
if ((window.location.pathname.startsWith("/hi/") || window.location.pathname === "/hi" || window.location.pathname === "/hi.html") && !window.location.pathname.includes("/reviews/")) {
  ...
  function translateURLs(parentElement) {
    var translations = {
      ...
      "BitSkins is an online marketplace for in-game skins, particularly for Counter-Strike: Global Offensive, Dota 2, and Team Fortress 2. Launched in 2015.": "BitSkins एक ऑनलाइन बाजार है खेल की स्किनों के लिए, विशेष रूप से Counter-Strike: Global Offensive, Dota 2 और Team Fortress 2 के लिए। 2015 में लॉन्च किया गया।",
      ...
      "BitSkins P2P is an online platform for buying and selling virtual items, with a focus on CS:GO skins. The parent company, BitSkins.": "BitSkins P2P एक ऑनलाइन प्लेटफ़ॉर्म है आभासी आइटमों की खरीद और बेच करने के लिए, विशेष रूप से CS:GO स्किनों पर ध्यान केंद्रित करता है। मूल कंपनी, BitSkins।",
      "Trusted CS:GO skin platform with rentals, endorsed by YouTubers. Secure, limited to CS:GO skins, fees apply, and user reviews indicate room for improve.": "विश्वसनीय CS:GO स्किन प्लेटफ़ॉर्म जिसमें किराए पर मिलने वाली सेवाएं हैं, YouTubers द्वारा समर्थित। सुरक्षित, सीएस: जीओ स्किनों तक सीमित है, शुल्क लागू होता है, और उपयोगकर्ता समीक्षाएं सुधार के लिए संकेत करती हैं।",
      "GamerPay is a trusted platform for buying and selling CS:GO skins, with a free selling option, secure transactions, and high-quality skin inspection tool.": "GamerPay एक विश्वसनीय प्लेटफ़ॉर्म है CS:GO स्किन खरीद और बेचने के लिए, जिसमें एक मुफ्त बिक्री विकल्प, सुरक्षित लेन-देन और उच्च गुणवत्ता वाला स्किन जांच उपकरण है।",
      "CSGO Market is an online P2P marketplace that provides a safe and secure platform for buying and selling CS:GO skins. Established in 2015.": "CSGO Market एक ऑनलाइन P2P बाजार है जो CS:GO स्किन खरीद और बेचने के लिए एक सुरक्षित और सुरक्षित प्लेटफ़ॉर्म प्रदान करता है। 2015 में स्थापित किया गया।",
      "Lis-Skins is a popular marketplace for Steam items, especially CS:GO, Rust and Dota 2 skins and items. The platform was founded in 2020.": "Lis-Skins एक लोकप्रिय बाजार है स्टीम आइटमों के लिए, विशेष रूप से CS:GO, Rust और Dota 2 स्किन और आइटम। प्लेटफ़ॉर्म का स्थापना 2020 में की गई थी।",
      "WhiteMarket is a P2P platform for CS:GO skin trading. It offers secure trades, various deposit options, and community engagement.": "WhiteMarket CS:GO स्किन ट्रेडिंग के लिए एक P2P प्लेटफ़ॉर्म है। इसमें सुरक्षित व्यापार, विभिन्न जमा विकल्प और समुदाय का सहयोग है।",
      "CS.Deals is a platform that allows users to buy, sell, and trade skins from popular games such as CS:GO, Dota 2, Rust, and Team Fortress 2. Working since 2016.": "CS.Deals एक प्लेटफ़ॉर्म है जो उपयोगकर्ताओं को CS:GO, Dota 2, Rust और Team Fortress 2 जैसे प्रसिद्ध खेलों से स्किन खरीदने, बेचने और व्यापार करने की अनुमति देता है। 2016 से काम कर रहा है।",
      "SkinBid is an online marketplace for CS:GO skins and in-game items, offering buying, selling, and auctioning features with a user-friendly interface.": "SkinBid एक ऑनलाइन बाजार है CS:GO स्किन और खेल की आइटमों के लिए, जो एक उपयोगकर्ता-मित्रतापूर्ण इंटरफ़ेस के साथ खरीदने, बेचने और नीलामी की सुविधाएं प्रदान करता है।",
      "Swap.gg is a website that allows users to buy, sell, and trade CS:GO, Rust , TF2 and other virtual items from various games. Working since 2017.": "Swap.gg एक वेबसाइट है जो उपयोगकर्ताओं को CS:GO, Rust, TF2 और अन्य विभिन्न खेलों की आभासी आइटम खरीदने, बेचने और व्यापार करने की अनुमति देती है। 2017 से काम कर रहा है।",
      "LOOT.Farm is an online platform that offers users the ability to Trade virtual items from popular games like CS:GO, Dota 2, Team Fortress 2, and Rust.": "LOOT.Farm एक ऑनलाइन प्लेटफ़ॉर्म है जो उपयोगकर्ताओं को CS:GO, Dota 2, Team Fortress 2 और Rust जैसे प्रसिद्ध खेलों से आभासी आइटम व्यापार करने की क्षमता प्रदान करता है।",
      "SkinBaron is an online platform based in Germany that enables users to buy and sell their CS:GO skins. The platform has gained a good reputation.": "SkinBaron जर्मनी में स्थित एक ऑनलाइन प्लेटफ़ॉर्म है जो उपयोगकर्ताओं को उनकी CS:GO स्किन खरीदने और बेचने की सुविधा प्रदान करता है। प्लेटफ़ॉर्म को एक अच्छी प्रतिष्ठा हासिल हुई है।",
      "Gamdom is one of the best CS:GO Match Betting Sites. You can play Roulette, Wheel, Crash, Slots and many more!":"Gamdom एक बेहतरीन CS:GO मैच बेटिंग साइटों में से एक है। आप रूलेट, व्हील, क्रैश, स्लॉट और बहुत कुछ खेल सकते हैं!",
      "Avan.Market is an online platform that offers users the opportunity to sell gaming skins from popular games like CS:GO, Dota 2, RUST, and TF2.": "Avan.Market एक ऑनलाइन प्लेटफ़ॉर्म है जो उपयोगकर्ताओं को CS:GO, Dota 2, RUST और TF2 जैसे प्रसिद्ध खेलों की गेमिंग स्किन बेचने का अवसर प्रदान करता है।",
      ...
      "SkinCashier is an online platform that allows players to Instant Sell their CS:GO, Rust, Dota 2, and TF2 skins for real money. Operating since 2020.": "SkinCashier एक ऑनलाइन प्लेटफ़ॉर्म है जो खिलाड़ियों को अपने CS:GO, Rust, Dota 2 और TF2 स्किन को तत्काल बेचने की अनुमति देता है और वास्तविक धन के लिए। 2020 से संचालित हो रहा है।",
      "CYBERSHOKE is a website that provides servers for playing CS:GO. It offers various servers for players to choose.":"CYBERSHOKE एक वेबसाइट है जो CS:GO खेलने के लिए सर्वर प्रदान करती है। यह खिलाड़ियों के लिए विभिन्न सर्वर प्रदान करता है जिन्हें चुनने के लिए।",
...
var sites = [
'<li><a href="/reviews/idle-empire.html">Idle-empire</a></li>',
'<li><a href="/reviews/insanegg.html">Insanegg</a></li>',
'<li><a href="/reviews/key-drop.html">Key-drop</a></li>',
'<li><a href="/reviews/knifex.html">Knifex</a></li>',
...
'<li><a href="/reviews/rollbit.html">Rollbit</a></li>',
'<li><a href="/reviews/roobet.html">Roobet</a></li>',
'<li><a href="/reviews/rustbet.html">Rustbet</a></li>',
'<li><a href="/reviews/rustcases.html">Rustcases</a></li>',
'<li><a href="/reviews/rustchance.html">Rustchance</a></li>',
'<li><a href="/reviews/rustclash.html">Rustclash</a></li>',
'<li><a href="/reviews/rustix.html">Rustix</a></li>',
'<li><a href="/reviews/rustmoment.html">Rustmoment</a></li>',
'<li><a href="/reviews/ruststake.html">Ruststake</a></li>',
'<li><a href="/reviews/rustyloot.html">Rustyloot</a></li>',
'<li><a href="/reviews/rustypot.html">Rustypot</a></li>',
'<li><a href="/reviews/salad.html">Salad</a></li>',
'<li><a href="/reviews/shadowpay">Shadowpay</a></li>',
'<li><a href="/reviews/skinbaron">Skinbaron</a></li>',
'<li><a href="/reviews/skinbet.html">Skinbet</a></li>',
'<li><a href="/reviews/skincashier">Skincashier</a></li>',
'<li><a href="/reviews/skinscash">Skinscash</a></li>',
'<li><a href="/reviews/skinswap.html">Skinswap</a></li>',
'<li><a href="/reviews/steamgifts.html">Steamgifts</a></li>',
'<li><a href="/reviews/steamlvlup">Steamlvlup</a></li>',
'<li><a href="/reviews/swapgg">Swapgg</a></li>',
'<li><a href="/reviews/tradeit">Tradeit</a></li>',
'<li><a href="/reviews/vvvgamers.html">Vvvgamers</a></li>',
'<li><a href="/reviews/wtfskins.html">Wtfskins</a></li>',
'<li><a href="/reviews/xplay.html">Xplay</a></li>',
'<li><a href="/reviews/avanmarket">Avanmarket</a></li>',
'<li><a href="/reviews/banditcamp.html">Banditcamp</a></li>',
'<li><a href="/reviews/bcgame.html">Bcgame</a></li>',
'<li><a href="/reviews/bets4pro.html">Bets4pro</a></li>',
...
'<li><a href="/reviews/csgoempire.html">CSGOEmpire</a></li>',
'<li><a href="/reviews/csgofast.html">CSGOFast</a></li>',
'<li><a href="/reviews/csgolive.html">CSGOLive</a></li>',
'<li><a href="/reviews/csgoluck.html">CSGOLuck</a></li>',
'<li><a href="/reviews/csgo-market">CSGO-Market</a></li>',
'<li><a href="/reviews/csgopolygon.html">CSGOPolygon</a></li>',
'<li><a href="/reviews/csgopositive.html">CSGOPositive</a></li>',
'<li><a href="/reviews/csgoroll.html">CSGORoll</a></li>',
'<li><a href="/reviews/csgoselly.html">CSGOSelly</a></li>',
'<li><a href="/reviews/csgo-skins.html">CSGO-Skins</a></li>',
'<li><a href="/reviews/cybershoke">Cybershoke</a></li>',
'<li><a href="/reviews/daddyskins.html">Daddyskins</a></li>',
'<li><a href="/reviews/datdrop.html">Datdrop</a></li>',
'<li><a href="/reviews/dmarket">Dmarket</a></li>',
'<li><a href="/reviews/duelbits.html">Duelbits</a></li>',
'<li><a href="/reviews/earnweb.html">Earnweb</a></li>',
'<li><a href="/reviews/farmskins.html">Farmskins</a></li>',
'<li><a href="/reviews/flamecases.html">Flamecases</a></li>',
'<li><a href="/reviews/freecash.html">Freecash</a></li>',
'<li><a href="/reviews/freeward.html">Freeward</a></li>',
'<li><a href="/reviews/gamdom.html">Gamdom</a></li>',
'<li><a href="/reviews/gamehag.html">Gamehag</a></li>',
'<li><a href="/reviews/gamerpay">Gamerpay</a></li>',
'<li><a href="/reviews/gametame.html">Gametame</a></li>',
'<li><a href="/reviews/gcskins.html">Gcskins</a></li>',
'<li><a href="/reviews/grindbux.html">Grindbux</a></li>',
'<li><a href="/reviews/hellcase.html">Hellcase</a></li>',
'<li><a href="/reviews/hellstore.html">Hellstore</a></li>',
'<li><a href="/reviews/howlgg.html">Howlgg</a></li>',
'<li><a href="/reviews/skinbid">SkinBid</a></li>',
'<li><a href="/reviews/shuffle.html">Shuffle</a></li>',
...
'<li><a href="/reviews/hypeup.html">Hypeup</a></li>'
];
...
if ((window.location.pathname.startsWith('/ru/') || window.location.pathname === '/ru') || window.location.pathname.endsWith("ru.html") && !window.location.pathname.includes('/reviews/')) {
        ...
        var allowedIds = ["CSGORoll", "CSGOEmpire", "Clash", "howlgg", "RustyPot", "RustChance", "Rollbit", "Duelbits", "InsaneGG", "FlameCases", "KNIFEX", "DaddySkins", "Hellcase", "CSGOFast", "CSGOLive", "WTFSkins", "Key-Drop", "FarmSkins"];
