...
function translateURLs(parentElement, language) {
  ...
  var translations = {
    "hi": {
      ...
      "CashoutCSGO is a platform solely dedicated to selling CS:GO skins for crypto or paypal, offering a convenient conversion service.":"CashoutCSGO एक प्लेटफ़ॉर्म है जो केवल सीएस:गो स्किन्स बेचने के लिए समर्पित है और सुविधाजनक परिवर्तन सेवा प्रदान करती है।",
    ...
    "tr": {
      ...
      "CashoutCSGO is a platform solely dedicated to selling CS:GO skins for crypto or paypal, offering a convenient conversion service.":"CashoutCSGO, sadece CS:GO skinleri satmaya adanmış bir platform olup, pratik bir dönüşüm hizmeti sunmaktadır.",
    ...
    "es": {
      ...
      "Lis-Skins is a popular marketplace for Steam items, especially CS:GO, Rust and Dota 2 skins and items. The platform was founded in 2020.":"Lis-Skins es un popular mercado para objetos de Steam, especialmente skins e ítems de CS:GO, Rust y Dota 2. La plataforma fue fundada en 2020.",
      ...
      "CashoutCSGO is a platform solely dedicated to selling CS:GO skins for crypto or paypal, offering a convenient conversion service.":"CashoutCSGO es una plataforma dedicada exclusivamente a la venta de skins de CS:GO, ofreciendo un servicio de conversión conveniente.",
    ...
    "pt": {
      ...
      "CashoutCSGO is a platform solely dedicated to selling CS:GO skins for crypto or paypal, offering a convenient conversion service.":"O CashoutCSGO é uma plataforma exclusivamente dedicada à venda de skins do CS:GO, oferecendo um serviço de conversão conveniente.",
...
if (window.location.pathname.includes('/ru/reviews/') || window.location.pathname.includes('/ru/mirrors/')) {
  ...
  for (var i = 0; i < links.length; i++) {
    ...
    if (!link.closest('div.siteblock div.box, ol li a')) {
