...
if ((window.location.pathname.startsWith('/ru/') || window.location.pathname === '/ru') || window.location.pathname.endsWith("ru.html") && !window.location.pathname.includes('/reviews/')) {
        ...
        var allowedIds = ["CSGORoll", "CSGOEmpire", "Clash", "Gamdom", "Rollbit", "Duelbits", "InsaneGG", "FlameCases", "KNIFEX", "DaddySkins", "Hellcase", "CSGOFast", "CSGOLive", "WTFSkins", "Key-Drop", "FarmSkins"];
