...
if ((window.location.pathname.startsWith("/es/") || window.location.pathname === "/es" || window.location.pathname === "/es.html") && !window.location.pathname.includes("/reviews/")) {
  ...
  function translateURLs(parentElement) {
    var translations = {
      ...
      "BanditCamp is a Rust skin gambling website that provides several Rust-themed game modes like wheel of fortune, case unboxings, and coinflip." : "BanditCamp es un sitio web de apuestas de skins de Rust que ofrece varios modos de juego temáticos de Rust, como la rueda de la fortuna, la apertura de cajas y el coinflip.",
      "GCSkins is a well-known mobile app and website that offers CSGO skins and items as rewards for completing online tasks. Available since 2016." : "GCSkins es una aplicación móvil y un sitio web bien conocidos que ofrecen skins y objetos de CSGO como recompensa por completar tareas en línea. Disponible desde 2016.",
      ...
      "Rust skin gambling site that has been around since 2017. The platform offers a range of popular games, including high-roller jackpot and coinflip games." : "Sitio de apuestas de skins de Rust que ha estado presente desde 2017. La plataforma ofrece una variedad de juegos populares, incluyendo juegos de jackpot y coinflip para grandes apostadores.",
      "RustBet - Trusted gambling site, Rust skins as rewards. Jackpot, coinflip, and skin upgrader games. Clean reputation, SSL encryption, user-friendly." : "RustBet: sitio de apuestas confiable, skins de Rust como recompensa. Jackpot, coinflip y juegos de mejora de skins. Buena reputación, encriptación SSL, fácil de usar.",
      "RustStake is a Rust skin gambling platform that offers a range of games, including jackpot and coinflip. Easily enter and withdraw items from games." : "RustStake es una plataforma de apuestas de skins de Rust que ofrece una variedad de juegos, incluyendo jackpot y coinflip. Entra y retira objetos de los juegos fácilmente.",
      ...
      "Site from Gamehag owners. Has a decent number of survey providers and offerwall partners to choose from, plenty of options for withdrawing earnings.": "Sitio de los propietarios de Gamehag. Tiene un número decente de proveedores de encuestas y socios de muros de ofertas para elegir, muchas opciones para retirar las ganancias.",
      ...
      "Secure P2P marketplace owned by Hellcase. SSL-encrypted, KYC verification, friendly design, competitive pricing, trusted trading platform.": "Mercado P2P seguro propiedad de Hellcase. Encriptado con SSL, verificación KYC, diseño amigable, precios competitivos, plataforma de negociación confiable.",
      ...
      "GamerPay is a trusted platform for buying and selling CS:GO skins, with a free selling option, secure transactions, and high-quality skin inspection tool.": "GamerPay es una plataforma confiable para comprar y vender skins de CS:GO, con una opción de venta gratuita, transacciones seguras y una herramienta de inspección de skins de alta calidad.",
      ...
      "WhiteMarket is a P2P platform for CS:GO skin trading. It offers secure trades, various deposit options, and community engagement.": "WhiteMarket es una plataforma P2P para el intercambio de skins de CS:GO. Ofrece intercambios seguros, diversas opciones de depósito y participación de la comunidad.",
      "CS.Deals is a platform that allows users to buy, sell, and trade skins from popular games such as CS:GO, Dota 2, Rust, and Team Fortress 2. Working since 2016.": "CS.Deals es una plataforma para comprar, vender y intercambiar skins de juegos populares como CS:GO, Dota 2, Rust y Team Fortress 2. Funcionando desde 2016.",
      "SkinBid is an online marketplace for CS:GO skins and in-game items, offering buying, selling, and auctioning features with a user-friendly interface.": "SkinBid es un mercado en línea para skins de CS:GO y objetos dentro del juego, que ofrece funciones de compra, venta y subasta con una interfaz fácil de usar.",
      ...
      "SkinBaron is an online platform based in Germany that enables users to buy and sell their CS:GO skins. The platform has gained a good reputation.": "SkinBaron es una plataforma en línea con sede en Alemania que permite a los usuarios comprar y vender sus skins de CS:GO. La plataforma ha ganado una buena reputación.",
      ...
      "Skins.Cash is a reputable platform with positive reviews, reliable customer support, and over six years of operation. Pricing not the best one.": "Skins.Cash es una plataforma confiable con reseñas positivas, soporte al cliente confiable y más de seis años de operación. Los precios no son los mejores.",
      ...
      "This site was created for easy leveling up Steam, you can sell emojis and profile backgrounds for Steam Trading Cards to fast level up.": "Este sitio se creó para subir de nivel fácilmente en Steam. Puedes vender emojis y fondos de perfil para las Cartas de Intercambio de Steam y subir de nivel rápidamente.",
      "SteamLevelU is a legitimate platform to buy Steam trading card packs for enhancing Steam account levels, associated with SH Level Up.": "SteamLevelU es una plataforma legítima para comprar paquetes de cartas de intercambio de Steam y mejorar los niveles de tu cuenta de Steam, asociada a SH Level Up.",
      ...
      "Withdraw Crypto, gift cards or real money!": "Retira criptomonedas, tarjetas de regalo o dinero real!",
      "Withdraw CS:GO Skins, Gift Cards or Crypto!": "Retira Skins de CS:GO, tarjetas de regalo o criptomonedas!",
      ...
      "Withdraw Steam Trading cards or Games.": "Retira cartas de intercambio de Steam o juegos!",
