...
window.addEventListener('resize', updateCategoryBoxHrefs);
  ...
  if ((window.location.pathname.startsWith('/ru/') || window.location.pathname === '/ru' || window.location.pathname === '/ru.html')) {
          ...
          var allowedIds = ["Clash", "HowlGG", "DMarket", "RustyPot", "RustChance", "Rollbit", "Primedice", "Duelbits", "FlameCases", "BCGame", "DaddySkins", "CSGOLive", "WTFSkins", "Key-Drop", "gcskins", "FarmSkins", "vvvgamers"];
