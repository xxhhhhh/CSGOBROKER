    ...
    if (!window.location.pathname.includes('/reviews/') && 
      ...
      var translations = {
        patterns: {
          ...
          "Free (\\d+\\.\\d{2})\\ Coins": {
            "es": "xote Monedas gratis",
            "tr": "Ücretsiz xote Jeton",
            "pt": "xote Moedas Grátis",
            "hi": "xote सिक्के मुफ्त"
          },
          "(\\d+)% Deposit Bonus": {
            "es": "+xote% Bono de depósito",
            "tr": "+xote% Depozito Bonusu",
            "pt": "xote% Bónus de Depósito",
            "hi": "+xote% जमा बोनस"
          },
          "(\\d+)% Sell Bonus": {
